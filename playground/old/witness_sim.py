...
class Witness(object):
    ...
    def activate_witness_publisher(self):
        """Routine to turn witness behavior from db subscriber to pub_socket for delegates by changing port"""
    ...
    def confirmed_transaction_routine(self, raw_tx):
        """take approvated transaction data, serialize it, and open pub_socket socket.
         Then publish along tx info to db sub and then unbind socket"""
