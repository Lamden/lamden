...
class TestBlockStorageDriver(TestCase):
    ...
    # def test_store_block_invalid_merkle_root(self):
    #     """
    #     Tests that store_block raises an assertion when an invalid Merkle root is passed in
    #     (root is not 64 char hex string)
    #     """
    #     params = self._build_valid_block_data_params()
    #
    #     # Try with invalid hex string
    #     params['merkle_root'] = 'X' * 64
    #     self.assertRaises(InvalidMerkleRootException, BlockStorageDriver.store_block, **params)
    #
    #     # Try with hex string of invalid length
    #     params['merkle_root'] = 'A' * 48
    #     self.assertRaises(InvalidMerkleRootException, BlockStorageDriver.store_block, **params)
    #
    # def test_store_block_invalid_merkle_leaves_hash(self):
    #     """
    #     Tests that store_block raises an assertion when an invalid Merkle leaf is passed in
    #     (merkle_leaves contains leaf that is not 64 char hex string)
    #     """
    #     params = self._build_valid_block_data_params()
    #
    #     # Try with invalid hex string
    #     params['merkle_leaves'][2] = 'X' * 64
    #     self.assertRaises(InvalidMerkleLeafException, BlockStorageDriver.store_block, **params)
    #
    #     # Try with invalid length
    #     params['merkle_leaves'][2] = 'X' * 40
    #     self.assertRaises(InvalidMerkleLeafException, BlockStorageDriver.store_block, **params)
    #
    # def test_store_block_invalid_merkle_leaves_length(self):
    #     """
    #     Tests that store_block raises an assertion when the length of merkle leaves does not equal the length of
    #     raw_transactions
    #     """
    #     pass
