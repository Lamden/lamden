...
class TestLargeNetwork(MPTestCase):
    ...
    def test_2_4_4(self):
        ...
        mn_0 = MPPubSubAuth(sk=TESTNET_MASTERNODES[0]['sk'], name='MN_0', config_fn=config_sub, assert_fn=assert_sub, block_until_rdy=BLOCK)
        mn_1 = MPPubSubAuth(sk=TESTNET_MASTERNODES[1]['sk'], name='MN_1', config_fn=config_sub, assert_fn=assert_sub, block_until_rdy=BLOCK)

        wit_0 = MPPubSubAuth(sk=TESTNET_WITNESSES[0]['sk'], name='WITNESS_0', config_fn=config_sub, assert_fn=assert_sub, block_until_rdy=BLOCK)
        wit_1 = MPPubSubAuth(sk=TESTNET_WITNESSES[1]['sk'], name='WITNESS_1', config_fn=config_sub, assert_fn=assert_sub, block_until_rdy=BLOCK)

        del_0 = MPPubSubAuth(sk=TESTNET_DELEGATES[0]['sk'], name='DELEGATE_0', config_fn=config_sub, assert_fn=assert_sub, block_until_rdy=BLOCK)
        del_1 = MPPubSubAuth(sk=TESTNET_DELEGATES[1]['sk'], name='DELEGATE_1', config_fn=config_sub, assert_fn=assert_sub, block_until_rdy=BLOCK)
        del_2 = MPPubSubAuth(sk=TESTNET_DELEGATES[2]['sk'], name='DELEGATE_2', config_fn=config_sub, assert_fn=assert_sub, block_until_rdy=BLOCK)
        del_3 = MPPubSubAuth(sk=TESTNET_DELEGATES[3]['sk'], name='DELEGATE_3', config_fn=config_sub, assert_fn=assert_sub, block_until_rdy=BLOCK)
