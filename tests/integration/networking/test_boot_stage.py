...
class TestNodeBaseBootStage(MPTestCase):
    ...
    def test_das_boot_5(self):
        ...
        mn_0 = MPNodeBase(sk=TESTNET_MASTERNODES[0]['sk'], name='[node_1]MN_0', config_fn=None, assert_fn=assert_das_boot, block_until_rdy=BLOCK)
        mn_1 = MPNodeBase(sk=TESTNET_MASTERNODES[1]['sk'], name='[node_2]MN_1', config_fn=None, assert_fn=assert_das_boot, block_until_rdy=BLOCK)
        wit_0 = MPNodeBase(sk=TESTNET_WITNESSES[0]['sk'], name='[node_3]WITNESS_0', config_fn=None, assert_fn=assert_das_boot, block_until_rdy=BLOCK)
        wit_1 = MPNodeBase(sk=TESTNET_WITNESSES[1]['sk'], name='[node_4]WITNESS_1', config_fn=None, assert_fn=assert_das_boot, block_until_rdy=BLOCK)
        del_0 = MPNodeBase(sk=TESTNET_DELEGATES[0]['sk'], name='[node_5]DELEGATE_0', config_fn=None, assert_fn=assert_das_boot, block_until_rdy=BLOCK)
        del_1 = MPNodeBase(sk=TESTNET_DELEGATES[1]['sk'], name='[node_5]DELEGATE_1', config_fn=None, assert_fn=assert_das_boot, block_until_rdy=BLOCK)
