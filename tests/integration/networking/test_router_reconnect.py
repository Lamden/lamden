...
#         node1 = MPPubSubAuth(sk=TESTNET_MASTERNODES[0]['sk'], name='node_1', config_fn=config_sub, assert_fn=assert_sub,
#                              block_until_rdy=BLOCK)
#         node2 = MPPubSubAuth(sk=TESTNET_MASTERNODES[1]['sk'], name='node_2', config_fn=config_sub, assert_fn=assert_sub,
#                              block_until_rdy=BLOCK)
#         node3 = MPPubSubAuth(sk=TESTNET_WITNESSES[0]['sk'], name='node_3', config_fn=config_sub, assert_fn=assert_sub,
#                              block_until_rdy=BLOCK)
#
...
#         node4 = MPPubSubAuth(sk=TESTNET_WITNESSES[1]['sk'], name='node_4', config_fn=config_sub, assert_fn=assert_sub,
#                              block_until_rdy=BLOCK)
#         node5 = MPPubSubAuth(sk=TESTNET_DELEGATES[0]['sk'], name='node_5', config_fn=config_sub, assert_fn=assert_sub,
#                              block_until_rdy=BLOCK)
#
