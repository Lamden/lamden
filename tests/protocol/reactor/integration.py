...
class TestReactorInterfacePubSub(ThiccTestCase):
    def test_1_1_1(self):
        """
    ...
    def test_subpub_1_n_1(self):
        ...
        sub1 = TTReactorInterface(config_fn=configure_interface, assert_fn=run_assertions, name='** SUB1')
        sub2 = TTReactorInterface(config_fn=configure_interface, assert_fn=run_assertions, name='** SUB2')
        sub3 = TTReactorInterface(config_fn=configure_interface, assert_fn=run_assertions, name='** SUB3')
        pub = TTReactorInterface(name='++ PUB')
    ...
    def test_pubsub_n_n_n_filters(self):
        ...
        4ish subs, 5ish pubs, 15ish messages, 7ish filters. A nice beefy network topology to assert on.
        """
        import random
