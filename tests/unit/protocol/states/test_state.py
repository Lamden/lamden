...
from cilantro_ee.protocol.states.decorators import StateTimeout, StateTransition, StateInput
...
class StateTest(TestCase):
    ...
    def test_call_transition_handler_general(self):
        ...
        with patch('cilantro_ee.protocol.states.state.asyncio') as mock_asyncio:
            mock_loop = MagicMock()
