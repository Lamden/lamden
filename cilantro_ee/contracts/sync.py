...
def submit_node_election_contracts(initial_masternodes, boot_mns, initial_delegates, boot_dels, master_price=50_000,
                                   delegate_price=50_000, root=os.path.dirname(__file__), client=ContractingClient()):
