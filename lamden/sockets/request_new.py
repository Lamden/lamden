...
class Request():
    ...
    def __init__(self, server_curve_vk: int = None, local_wallet: Wallet = None, ctx: zmq.Context = None,
                 local_ip: str = None, to_address: str = None):
    ...
    def connect_socket(self, address: str) -> None:
    ...
    def setup_socket(self) -> None:
        ...
        if self.to_address:
            self.connect_socket(address=self.to_address)
    ...
    def send_string(self, str_msg: str) -> None:
        ...
        return self.socket.send_string(str_msg, track=True)
    ...
    async def send(self, str_msg: str, timeout: int = 2500, retries: int = 3) -> Result:
        error = None
        ...
        while connection_attempts < retries:
            ...
            try:
                ...
                tracking = self.send_string(str_msg=str_msg)
